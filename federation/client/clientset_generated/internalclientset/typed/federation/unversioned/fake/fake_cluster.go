...
func (c *FakeClusters) Create(cluster *federation.Cluster) (result *federation.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(core.NewRootCreateAction("clusters", cluster), &federation.Cluster{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusters) Update(cluster *federation.Cluster) (result *federation.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(core.NewRootUpdateAction("clusters", cluster), &federation.Cluster{})
	if obj == nil {
		return nil, err
	}
	return obj.(*federation.Cluster), err
...
func (c *FakeClusters) UpdateStatus(cluster *federation.Cluster) (*federation.Cluster, error) {
	obj, err := c.Fake.
		Invokes(core.NewRootUpdateSubresourceAction("clusters", "status", cluster), &federation.Cluster{})
	if obj == nil {
		return nil, err
	}
	return obj.(*federation.Cluster), err
...
func (c *FakeClusters) Delete(name string, options *api.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(core.NewRootDeleteAction("clusters", name), &federation.Cluster{})
	return err
}
...
func (c *FakeClusters) Get(name string) (result *federation.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(core.NewRootGetAction("clusters", name), &federation.Cluster{})
	if obj == nil {
		return nil, err
	}
	return obj.(*federation.Cluster), err
...
func (c *FakeClusters) List(opts api.ListOptions) (result *federation.ClusterList, err error) {
	obj, err := c.Fake.
		Invokes(core.NewRootListAction("clusters", opts), &federation.ClusterList{})
	if obj == nil {
		return nil, err
	}
