...
import (
	...
	pkg6_extensions "k8s.io/kubernetes/pkg/apis/extensions"
	pkg5_types "k8s.io/kubernetes/pkg/types"
	pkg7_intstr "k8s.io/kubernetes/pkg/util/intstr"
	"reflect"
	"runtime"
...
func init() {
	...
	if false { // reference the types, but skip this branch at build/run time
		...
		var v3 pkg6_extensions.ReplicaSetSpec
		var v4 pkg5_types.UID
		var v5 pkg7_intstr.IntOrString
		var v6 pkg4_inf.Dec
		var v7 time.Time
...
func (x *SubReplicaSet) CodecEncodeSelf(e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	if x == nil {
...
func (x *SubReplicaSet) CodecDecodeSelf(d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	yym1 := z.DecBinary()
...
func (x *SubReplicaSet) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yys3Slc = z.DecScratchBuffer() // default slice to decode into
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "spec":
			if r.TryDecodeAsNil() {
				x.Spec = pkg6_extensions.ReplicaSetSpec{}
			} else {
				yyv5 := &x.Spec
				yyv5.CodecDecodeSelf(d)
			}
		case "status":
			if r.TryDecodeAsNil() {
				x.Status = pkg6_extensions.ReplicaSetStatus{}
			} else {
				yyv6 := &x.Status
				yyv6.CodecDecodeSelf(d)
			}
...
func (x *SubReplicaSet) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yyj9 int
...
func (x *SubReplicaSetList) CodecEncodeSelf(e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	if x == nil {
			...
			if yyr2 || yy2arr2 {
				...
				if x.Items == nil {
					...
					if false {
						...
						h.encSliceSubReplicaSet(([]SubReplicaSet)(x.Items), e)
					}
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey1234)
...
func (x *SubReplicaSetList) CodecDecodeSelf(d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	yym1 := z.DecBinary()
...
func (x *SubReplicaSetList) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yys3Slc = z.DecScratchBuffer() // default slice to decode into
		...
		case "items":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceSubReplicaSet((*[]SubReplicaSet)(yyv6), d)
				}
			}
		case "kind":
			if r.TryDecodeAsNil() {
...
func (x *SubReplicaSetList) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yyj10 int
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceSubReplicaSet((*[]SubReplicaSet)(yyv13), d)
		}
	}
	yyj10++
	if yyhl10 {
...
func (x codecSelfer1234) encSliceSubReplicaSet(v []SubReplicaSet, e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer1234) decSliceSubReplicaSet(v *[]SubReplicaSet, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	...
	if yyl1 == 0 {
		...
		if yyrt1 {
			for ; yyj1 < yyl1; yyj1++ {
				yyv1 = append(yyv1, SubReplicaSet{})
				yyh1.ElemContainerState(yyj1)
				if r.TryDecodeAsNil() {
					yyv1[yyj1] = SubReplicaSet{}
				} else {
		...
		for ; !r.CheckBreak(); yyj1++ {
			...
			if yyj1 >= len(yyv1) {
				yyv1 = append(yyv1, SubReplicaSet{}) // var yyz1 SubReplicaSet
				yyc1 = true
			}
			yyh1.ElemContainerState(yyj1)
			if yyj1 < len(yyv1) {
