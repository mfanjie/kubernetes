...
import (
	...
	pkg6_v1beta1 "k8s.io/kubernetes/pkg/apis/extensions/v1beta1"
...
func init() {
	...
	if false { // reference the types, but skip this branch at build/run time
		...
		var v3 pkg6_v1beta1.ReplicaSetSpec
...
func (x *SubReplicaSet) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "spec":
			if r.TryDecodeAsNil() {
				x.Spec = pkg6_v1beta1.ReplicaSetSpec{}
			} else {
				yyv5 := &x.Spec
				yyv5.CodecDecodeSelf(d)
			}
		case "status":
			if r.TryDecodeAsNil() {
				x.Status = pkg6_v1beta1.ReplicaSetStatus{}
			} else {
				yyv6 := &x.Status
				yyv6.CodecDecodeSelf(d)
			}
