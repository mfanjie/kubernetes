...
func TestControllerStrategy(t *testing.T) {
	...
	rc := &controlplane.SubReplicationController{
	...
	invalidRc := &controlplane.SubReplicationController{
...
func TestControllerStatusStrategy(t *testing.T) {
	...
	oldController := &controlplane.SubReplicationController{
	...
	newController := &controlplane.SubReplicationController{
...
func TestSelectableFieldLabelConversions(t *testing.T) {
	apitesting.TestSelectableFieldLabelConversionsOfKind(t,
		...
		"SubReplicationController",
		labels.Set(ControllerToSelectableFields(&controlplane.SubReplicationController{})),
		nil,
	)
}
