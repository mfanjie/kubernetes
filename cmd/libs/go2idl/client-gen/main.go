...
var (
	...
	inputVersions = flag.StringSlice("input", []string{"api/", "extensions/", "controlplane/"}, "group/versions that client-gen will generate clients for. At most one version per group is allowed. Specified in the format \"group1/version1,group2/version2...\". Default to \"api/,extensions\"")
